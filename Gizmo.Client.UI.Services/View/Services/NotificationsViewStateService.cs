...
{
    [Register()]
    public sealed class NotificationsViewStateService : ViewStateServiceBase<NotificationsViewState>
    {
        #region CONSTRUCTOR
        public NotificationsViewStateService(NotificationsViewState viewState,
            ILogger<NotificationsViewStateService> logger,
