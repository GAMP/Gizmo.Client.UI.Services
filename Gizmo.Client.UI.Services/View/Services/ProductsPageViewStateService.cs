...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class ProductsPageViewStateService : ViewStateServiceBase<ProductsPageViewState>
    {
        ...
        public ProductsPageViewStateService(
            IServiceProvider serviceProvider,
            ILogger<ProductsPageViewStateService> logger,
