...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserProfileViewStateService : ViewStateServiceBase<UserProfileViewState>, IDisposable
    {
        public UserProfileViewStateService(UserProfileViewState viewState,
            IGizmoClient gizmoClient,
            ILogger<UserProfileViewStateService> logger,
