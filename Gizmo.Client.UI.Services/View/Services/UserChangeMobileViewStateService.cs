...
{
    [Register()]
    public sealed class UserChangeMobileViewStateService : ValidatingViewStateServiceBase<UserChangeMobileViewState>
    {
        #region CONSTRUCTOR
        public UserChangeMobileViewStateService(UserChangeMobileViewState viewState,
            ILogger<UserChangeMobileViewStateService> logger,
