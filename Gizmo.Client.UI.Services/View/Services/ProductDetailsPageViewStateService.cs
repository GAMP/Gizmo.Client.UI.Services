...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class ProductDetailsPageViewStateService : ViewStateServiceBase<ProductDetailsPageViewState>
    {
        #region CONSTRUCTOR
        public ProductDetailsPageViewStateService(ProductDetailsPageViewState viewState,
            ILogger<ProductDetailsPageViewStateService> logger,
