...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserRegistrationConfirmationViewStateService : ValidatingViewStateServiceBase<UserRegistrationConfirmationViewState>
    {
        #region CONSTRUCTOR
        public UserRegistrationConfirmationViewStateService(UserRegistrationConfirmationViewState viewState,
            ILogger<UserRegistrationConfirmationViewStateService> logger,
            IServiceProvider serviceProvider,
            ILocalizationService localizationService,
            IGizmoClient gizmoClient,
            UserRegistrationViewState userRegistrationViewState,
            UserRegistrationConfirmationMethodViewStateService userRegistrationConfirmationMethodService,
        ...
        private readonly UserRegistrationConfirmationMethodViewStateService _userRegistrationConfirmationMethodService;
            ...
            if (fieldIdentifier.FieldEquals(() => ViewState.ConfirmationCode))
            {
                if (!string.IsNullOrEmpty(ViewState.ConfirmationCode))
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        return new string[] { _localizationService.GetString("VE_ERROR_CANNOT_VALIDATE_RECOVERY_TOKEN") };
                    }
                }
            }
