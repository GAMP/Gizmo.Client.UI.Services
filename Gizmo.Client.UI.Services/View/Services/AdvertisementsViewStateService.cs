...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class AdvertisementsViewStateService : ViewStateServiceBase<AdvertisementsViewState>
    {
        #region CONSTRUCTOR
        public AdvertisementsViewStateService(
            ILogger<AdvertisementsViewStateService> logger,
