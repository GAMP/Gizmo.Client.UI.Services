...
{
    [Register()]
    public sealed class UserRegistrationConfirmationMethodViewStateService : ValidatingViewStateServiceBase<UserRegistrationConfirmationMethodViewState>
    {
        #region CONSTRUCTOR
        public UserRegistrationConfirmationMethodViewStateService(UserRegistrationConfirmationMethodViewState viewState,
            ILogger<UserRegistrationConfirmationMethodViewStateService> logger,
