...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserPasswordRecoveryViewStateService : ValidatingViewStateServiceBase<UserPasswordRecoveryViewState>
    {
        #region CONTRUCTOR
        public UserPasswordRecoveryViewStateService(UserPasswordRecoveryViewState viewState,
            ILogger<UserPasswordRecoveryViewStateService> logger,
            IServiceProvider serviceProvider,
            ILocalizationService localizationService,
            IGizmoClient gizmoClient,
            UserPasswordRecoveryMethodServiceViewState userPasswordRecoveryMethodServiceViewState,
             UserVerificationViewStateService userVerificationService,
            UserVerificationFallbackViewStateService userVerificationFallbackService) : base(viewState, logger, serviceProvider)
        {
        ...
        private readonly UserVerificationViewStateService _userVerificationService;
        private readonly UserVerificationFallbackViewStateService _userVerificationFallbackService;
        #endregion
        ...
        {
            var userPasswordRecoveryConfirmationService = ServiceProvider.GetRequiredService<UserPasswordRecoveryConfirmationViewStateService>();
            var userPasswordRecoverySetNewPasswordService = ServiceProvider.GetRequiredService<UserPasswordRecoverySetNewPasswordViewStateService>();
