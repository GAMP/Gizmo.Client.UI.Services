...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class QuickLaunchViewStateService : ViewStateServiceBase<QuickLaunchViewState>
    {
        #region CONSTRUCTOR
        public QuickLaunchViewStateService(QuickLaunchViewState viewState,
            ILogger<QuickLaunchViewStateService> logger,
