...
{
    [Register()]
    public sealed class GlobalSearchViewStateService : ViewStateServiceBase<GlobalSearchViewState>
    {
        #region FIELDS
        ...
        #region CONSTRUCTOR
        public GlobalSearchViewStateService(
            ...
            ILogger<GlobalSearchViewStateService> logger,
        ...
        public async Task ProcessEnterAsync()
        {
            ...
            else
            {
                ...
                if (ViewState.ProductResults.Count() > 0)
                {
                    ...
                    {
                        //Only one result execute action.
                        var userCartService = ServiceProvider.GetRequiredService<UserCartViewStateService>();
