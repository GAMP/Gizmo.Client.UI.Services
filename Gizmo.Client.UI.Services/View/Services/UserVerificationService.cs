...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserVerificationService : ViewStateServiceBase<UserVerificationViewState>
    {
        private const int VERIFICATION_DELAY = 60;

        #region CONTRUCTOR
        public UserVerificationService(UserVerificationViewState viewState,
