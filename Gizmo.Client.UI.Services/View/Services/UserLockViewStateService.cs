...
{
    [Register()]
    public sealed class UserLockViewStateService : ValidatingViewStateServiceBase<UserLockViewState>, IDisposable
    {
        #region CONSTRUCTOR
        public UserLockViewStateService(UserLockViewState viewState,
            ILogger<UserLockViewStateService> logger,
