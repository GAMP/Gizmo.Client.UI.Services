...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class PurchasesViewStateService : ViewStateServiceBase<PurchasesViewState>
    {
        #region CONSTRUCTOR
        public PurchasesViewStateService(PurchasesViewState viewState,
            ILogger<PurchasesViewStateService> logger,
