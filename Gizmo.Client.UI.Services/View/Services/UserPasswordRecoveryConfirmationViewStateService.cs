...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserPasswordRecoveryConfirmationViewStateService : ValidatingViewStateServiceBase<UserPasswordRecoveryConfirmationViewState>
    {
        #region CONTRUCTOR
        public UserPasswordRecoveryConfirmationViewStateService(UserPasswordRecoveryConfirmationViewState viewState,
            ILogger<UserPasswordRecoveryViewStateService> logger,
            IServiceProvider serviceProvider,
            ILocalizationService localizationService,
            IGizmoClient gizmoClient,
            UserPasswordRecoveryViewStateService userPasswordRecoveryService,
        ...
        private readonly UserPasswordRecoveryViewStateService _userPasswordRecoveryService;
