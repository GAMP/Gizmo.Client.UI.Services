...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class DepositTransactionsViewStateService : ViewStateServiceBase<DepositTransactionsViewState>
    {
        #region CONSTRUCTOR
        public DepositTransactionsViewStateService(DepositTransactionsViewState viewState,
            ILogger<DepositTransactionsViewStateService> logger,
