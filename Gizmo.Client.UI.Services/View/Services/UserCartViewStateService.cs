...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserCartViewStateService : ValidatingViewStateServiceBase<UserCartViewState>
    {
        #region CONSTRUCTOR
        public UserCartViewStateService(
            IServiceProvider serviceProvider,
            ILogger<UserCartViewStateService> logger,
