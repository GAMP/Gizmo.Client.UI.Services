...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserVerificationViewStateService : ViewStateServiceBase<UserVerificationViewState>
    {
        private const int VERIFICATION_DELAY = 60;

        #region CONTRUCTOR
        public UserVerificationViewStateService(UserVerificationViewState viewState,
            ILogger<UserVerificationViewStateService> logger,
