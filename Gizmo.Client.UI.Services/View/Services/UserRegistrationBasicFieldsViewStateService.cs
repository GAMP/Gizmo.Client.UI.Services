...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserRegistrationBasicFieldsViewStateService : ValidatingViewStateServiceBase<UserRegistrationBasicFieldsViewState>
    {
        #region CONSTRUCTOR
        public UserRegistrationBasicFieldsViewStateService(UserRegistrationBasicFieldsViewState viewState,
            ILogger<UserRegistrationBasicFieldsViewStateService> logger,
