...
namespace Gizmo.Client.UI.View.Services
{
    ...
    [Register()]
    public sealed class UserLoginViewStateService : ValidatingViewStateServiceBase<UserLoginViewState>
    {
        public UserLoginViewStateService(
            UserLoginViewState viewState,
            ILogger<UserLoginViewStateService> logger,
