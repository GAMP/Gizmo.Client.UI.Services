...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserSettingsViewStateService : ValidatingViewStateServiceBase<UserSettingsViewState>
    {
        #region CONSTRUCTOR
        public UserSettingsViewStateService(UserSettingsViewState viewState,
            ILogger<UserSettingsViewStateService> logger,
