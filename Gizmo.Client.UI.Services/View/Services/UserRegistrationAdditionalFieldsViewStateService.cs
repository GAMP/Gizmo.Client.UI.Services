...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserRegistrationAdditionalFieldsViewStateService : ValidatingViewStateServiceBase<UserRegistrationAdditionalFieldsViewState>
    {
        #region CONSTRUCTOR
        public UserRegistrationAdditionalFieldsViewStateService(UserRegistrationAdditionalFieldsViewState viewState,
            ILogger<UserRegistrationAdditionalFieldsViewStateService> logger,
