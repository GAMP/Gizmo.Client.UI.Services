...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class UserVerificationFallbackViewStateService : ViewStateServiceBase<UserVerificationFallbackViewState>
    {
        private const int FALLBACK_DELAY = 30;

        #region CONTRUCTOR
        public UserVerificationFallbackViewStateService(UserVerificationFallbackViewState viewState,
            ILogger<UserVerificationFallbackViewStateService> logger,
