...
namespace Gizmo.Client.UI.View.Services
{
    ...
    public sealed class TimeProductsViewStateService : ViewStateServiceBase<TimeProductsViewState>
    {
        #region CONSTRUCTOR
        public TimeProductsViewStateService(TimeProductsViewState viewState,
            ILogger<TimeProductsViewStateService> logger,
